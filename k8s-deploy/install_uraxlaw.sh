...
echo "Deploying production UraxLaw (using external databases)..."
...
helm upgrade --install uraxlaw $SCRIPT_DIR/uraxlaw \
  --namespace $NAMESPACE \
...
echo ""
echo "Waiting for uraxlaw pod to be ready..."
kubectl wait --for=condition=ready pod -l app.kubernetes.io/instance=uraxlaw --timeout=300s -n rag
echo "uraxlaw pod is ready"
echo ""
echo "Running Port-Forward:"
echo "    kubectl --namespace rag port-forward svc/uraxlaw 9621:9621"
echo "==========================================="
echo ""
