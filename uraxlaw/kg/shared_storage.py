...
from uraxlaw.exceptions import PipelineNotInitializedError
...
def direct_log(message, enable_output: bool = False, level: str = "DEBUG"):
    ...
    # Get the current logger level from the uraxlaw logger
    try:
        from uraxlaw.utils import logger

        current_level = logger.getEffectiveLevel()
    except ImportError:
        # Fallback if uraxlaw.utils is not available
