...
import numpy as np
from uraxlaw.utils import logger, compute_mdhash_id
...
class MilvusVectorDBStorage(BaseVectorStorage):
    def _create_schema_for_namespace(self) -> CollectionSchema:
        ...
        if self.namespace.endswith("entities"):
            ...
            description = "UraxLaw entities vector storage"
            ...
            description = "UraxLaw relationships vector storage"
            ...
            description = "UraxLaw chunks vector storage"
            ...
            description = "UraxLaw generic vector storage"
