...
UraxLaw supports LlamaIndex for embeddings and completions in two ways: direct OpenAI usage or through LiteLLM proxy.
...
from uraxlaw.llm.llama_index_impl import llama_index_complete_if_cache, llama_index_embed
...
# Initialize UraxLaw with OpenAI
rag = UraxLaw(
...
# Initialize UraxLaw with LiteLLM
rag = UraxLaw(
    working_dir="your/path",
    llm_model_func=llm_model_func,
    embedding_func=EmbeddingFunc(
