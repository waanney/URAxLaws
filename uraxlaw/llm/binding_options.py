...
from uraxlaw.constants import DEFAULT_TEMPERATURE
...
# in UraxLaw. It provides a standardized framework for:
#
...
class BindingOptions:
    ...
    def generate_dot_env_sample(cls):
        """
        Generate a sample .env file for all UraxLaw binding options.
        ...
        sample_top = (
            ...
            + "\n"
            + (
                "# Autogenerated .env entries list for UraxLaw binding options\n"
                "#\n"
                "# To generate run:\n"
                "# $ python -m uraxlaw.llm.binding_options\n"
            )
            + "#" * 80
            + "\n"
        )
        ...
        sample_bottom = (
            ("#\n# End of .env entries for UraxLaw binding options\n")
            + "#" * 80
            + "\n"
        )
...
#
# Usage:
#   python -m uraxlaw.llm.binding_options           # Generate .env sample
#   python -m uraxlaw.llm.binding_options test      # Test argument parsing
#
# =============================================================================
