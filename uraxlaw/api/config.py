...
from uraxlaw.llm.binding_options import (
    OllamaEmbeddingOptions,
    OllamaLLMOptions,
    OpenAILLMOptions,
)
from uraxlaw.base import OllamaServerInfos
import sys
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="UraxLaw API Server")
    ...
    parser.add_argument(
        "--key",
        type=str,
        default=get_env_value("URAXLAW_API_KEY", None),
        help="API key for authentication. This protects uraxlaw server against unauthorized access",
    )
    ...
    parser.add_argument(
        ...
        help="Name for the simulated Ollama model (default: from env or uraxlaw)",
    )
    ...
    args.kv_storage = get_env_value(
        "URAXLAW_KV_STORAGE", DefaultRAGStorageConfig.KV_STORAGE
    )
    args.doc_status_storage = get_env_value(
        "URAXLAW_DOC_STATUS_STORAGE", DefaultRAGStorageConfig.DOC_STATUS_STORAGE
    )
    args.graph_storage = get_env_value(
        "URAXLAW_GRAPH_STORAGE", DefaultRAGStorageConfig.GRAPH_STORAGE
    )
    args.vector_storage = get_env_value(
        "URAXLAW_VECTOR_STORAGE", DefaultRAGStorageConfig.VECTOR_STORAGE
    )
    ...
    args.token_secret = get_env_value("TOKEN_SECRET", "uraxlaw-jwt-default-secret")
    ...
    ollama_server_infos.URAXLAW_NAME = args.simulated_model_name
    ollama_server_infos.URAXLAW_TAG = args.simulated_model_tag
