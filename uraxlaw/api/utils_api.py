"""
Utility functions for the UraxLaw API.
"""
...
from uraxlaw.api import __api_version__ as api_version
from uraxlaw import __version__ as core_version
...
def display_splash_screen(args: argparse.Namespace) -> None:
    """
    Display a colorful splash screen showing UraxLaw server configuration
    ...
    line1_text = f"UraxLaw Server v{core_version}/{api_version}"
    ...
    ASCIIColors.yellow(f"{ollama_server_infos.URAXLAW_MODEL}")
