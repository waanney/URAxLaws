...
from uraxlaw.api.utils_api import (
...
from uraxlaw.utils import get_env_value
from uraxlaw import UraxLaw, __version__ as core_version
from uraxlaw.api import __api_version__
from uraxlaw.types import GPTKeywordExtractionFormat
from uraxlaw.utils import EmbeddingFunc
from uraxlaw.constants import (
    DEFAULT_LOG_MAX_BYTES,
    DEFAULT_LOG_BACKUP_COUNT,
    DEFAULT_LOG_FILENAME,
)
from uraxlaw.api.routers.document_routes import (
    DocumentManager,
    create_document_routes,
    run_scanning_process,
)
from uraxlaw.api.routers.query_routes import create_query_routes
from uraxlaw.api.routers.graph_routes import create_graph_routes
from uraxlaw.api.routers.ollama_api import OllamaAPI

from uraxlaw.utils import logger, set_verbose_debug
from uraxlaw.kg.shared_storage import (
    get_namespace_data,
...
from uraxlaw.api.auth import auth_handler
...
def create_app(args):
    ...
    api_key = os.getenv("URAXLAW_API_KEY") or args.key
    ...
    # Initialize FastAPI
    app_kwargs = {
        "title": "UraxLaw Server API",
        "description": (
            "Providing API for UraxLaw core, Web UI and Ollama Model Emulation"
            + "(With authentication)"
            if api_key
            else ""
        ),
    ...
    if args.llm_binding == "lollms" or args.embedding_binding == "lollms":
        from uraxlaw.llm.lollms import lollms_model_complete, lollms_embed
    if args.llm_binding == "ollama" or args.embedding_binding == "ollama":
        from uraxlaw.llm.ollama import ollama_model_complete, ollama_embed
        from uraxlaw.llm.binding_options import OllamaLLMOptions
    if args.llm_binding == "openai" or args.embedding_binding == "openai":
        from uraxlaw.llm.openai import openai_complete_if_cache, openai_embed
        from uraxlaw.llm.binding_options import OpenAILLMOptions
    if args.llm_binding == "azure_openai" or args.embedding_binding == "azure_openai":
        from uraxlaw.llm.azure_openai import (
            azure_openai_complete_if_cache,
            azure_openai_embed,
        )
        from uraxlaw.llm.binding_options import OpenAILLMOptions
    if args.llm_binding == "aws_bedrock" or args.embedding_binding == "aws_bedrock":
        from uraxlaw.llm.bedrock import bedrock_complete_if_cache, bedrock_embed
    if args.embedding_binding == "ollama":
        from uraxlaw.llm.binding_options import OllamaEmbeddingOptions
    if args.embedding_binding == "jina":
        from uraxlaw.llm.jina import jina_embed
    ...
    if args.rerank_binding != "null":
        from uraxlaw.rerank import cohere_rerank, jina_rerank, ali_rerank
    ...
    from uraxlaw.api.config import OllamaServerInfos
...
def configure_logging():
    ...
    for logger_name in ["uvicorn", "uvicorn.access", "uvicorn.error", "uraxlaw"]:
    ...
    print(f"\nUraxLaw log file: {log_file_path}\n")
    ...
    logging.config.dictConfig(
        {
            ...
            "filters": {
                "path_filter": {
                    "()": "uraxlaw.utils.UraxlawPathFilter",
                },
            },
        }
    )
