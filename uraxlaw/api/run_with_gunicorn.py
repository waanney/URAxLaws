#!/usr/bin/env python
"""
Start UraxLaw server with Gunicorn
"""
...
from uraxlaw.api.utils_api import display_splash_screen, check_env_file
from uraxlaw.api.config import global_args
from uraxlaw.utils import get_env_value
from uraxlaw.kg.shared_storage import initialize_share_data, finalize_share_data
...
def main():
    ...
    print("🚀 Starting UraxLaw with Gunicorn")
    ...
    class GunicornApp(BaseApplication):
        ...
        def load_config(self):
            ...
            from uraxlaw.api import gunicorn_config
        ...
        def load(self):
            ...
            from uraxlaw.api.uraxlaw_server import get_application
    ...
    if workers_count > 1:
        ...
        os.environ["URAXLAW_MAIN_PROCESS"] = "1"
