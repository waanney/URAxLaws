"""
Centralized configuration constants for UraxLaw.

This module defines default values for configuration constants used across
different parts of the UraxLaw system. Centralizing these values ensures
