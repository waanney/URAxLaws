# UraxLaw 3D Graph Viewer

An interactive 3D graph visualization tool included in the UraxLaw package for visualizing and analyzing RAG (Retrieval-Augmented Generation) graphs and other graph structures.
...
### Quick Install
```bash
pip install uraxlaw-hku[tools]  # Install with visualization tool only
# or
pip install uraxlaw-hku[api,tools]  # Install with both API and visualization tools
```
...
1. **Command Not Found**
   ...
   pip install uraxlaw-hku[tools]

   # Verify installation
   pip list | grep uraxlaw-hku
   ```
...
- GitHub Issues: [UraxLaw Repository](https://github.com/HKUDS/UraxLaw)
- Documentation: [UraxLaw Docs](https://URL-to-docs)

## License

This tool is part of UraxLaw and is distributed under the MIT License. See `LICENSE` for more information.

Note: This visualization tool is an optional component of the UraxLaw package. Install with the [tools] option to access the viewer functionality.
