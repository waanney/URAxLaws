...
@dataclass
class UraxLaw:
    """UraxLaw: Simple and Fast Retrieval-Augmented Generation."""
    ...
    # TODO: Deprecated (UraxLaw will never initialize storage automatically on creation，and finalize should be call before destroying)
    auto_manage_storages_states: bool = field(default=False)
    """If True, uraxlaw will automatically calls initialize_storages and finalize_storages at the appropriate times."""
    ...
    def __post_init__(self):
        ...
        logger.debug(f"UraxLaw init with param:\n  {_print_config}\n")
    ...
    def _get_storage_class(self, storage_name: str) -> Callable[..., Any]:
        ...
        if storage_name == "JsonKVStorage":
            from uraxlaw.kg.json_kv_impl import JsonKVStorage

            return JsonKVStorage
        elif storage_name == "NanoVectorDBStorage":
            from uraxlaw.kg.nano_vector_db_impl import NanoVectorDBStorage

            return NanoVectorDBStorage
        elif storage_name == "NetworkXStorage":
            from uraxlaw.kg.networkx_impl import NetworkXStorage

            return NetworkXStorage
        elif storage_name == "JsonDocStatusStorage":
            from uraxlaw.kg.json_doc_status_impl import JsonDocStatusStorage
