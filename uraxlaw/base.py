...
class OllamaServerInfos:
    def __init__(self, name=None, tag=None):
        self._uraxlaw_name = name or os.getenv(
            "OLLAMA_EMULATING_MODEL_NAME", DEFAULT_OLLAMA_MODEL_NAME
        )
        self._uraxlaw_tag = tag or os.getenv(
            "OLLAMA_EMULATING_MODEL_TAG", DEFAULT_OLLAMA_MODEL_TAG
        )
        self.URAXLAW_SIZE = DEFAULT_OLLAMA_MODEL_SIZE
        self.URAXLAW_CREATED_AT = DEFAULT_OLLAMA_CREATED_AT
        self.URAXLAW_DIGEST = DEFAULT_OLLAMA_DIGEST

    @property
    def URAXLAW_NAME(self):
        return self._uraxlaw_name

    @URAXLAW_NAME.setter
    def URAXLAW_NAME(self, value):
        self._uraxlaw_name = value

    @property
    def URAXLAW_TAG(self):
        return self._uraxlaw_tag

    @URAXLAW_TAG.setter
    def URAXLAW_TAG(self, value):
        self._uraxlaw_tag = value

    @property
    def URAXLAW_MODEL(self):
        return f"{self._uraxlaw_name}:{self._uraxlaw_tag}"
...
@dataclass
class QueryParam:
    """Configuration parameters for query execution in UraxLaw."""
