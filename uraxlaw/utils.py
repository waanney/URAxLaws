...
try:
    ...
    logger = logging.getLogger("uraxlaw")
...
if TYPE_CHECKING:
    from uraxlaw.base import BaseKVStorage, BaseVectorStorage, QueryParam
...
class UraxlawPathFilter(logging.Filter):
    """Filter for uraxlaw logger to filter out frequent path access logs"""
...
def setup_logger(
    ...
    Args:
        ...
        add_filter: Whether to add UraxlawPathFilter to the logger
        log_file_path: Path to the log file. If None and file logging is enabled, defaults to uraxlaw.log in LOG_DIR or cwd
...
async def aexport_data(
    ...
    if file_format == "csv":
        ...
        with open(output_path, "w", encoding="utf-8") as mdfile:
            mdfile.write("# UraxLaw Data Export\n\n")
        ...
        with open(output_path, "w", encoding="utf-8") as txtfile:
            txtfile.write("URAXLAW DATA EXPORT\n")
            txtfile.write("=" * 80 + "\n\n")
...
def check_storage_env_vars(storage_name: str) -> None:
    ...
    """
    from uraxlaw.kg import STORAGE_ENV_REQUIREMENTS
